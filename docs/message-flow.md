...
## Neovim Plugin Flow (Vimbeam)

The Neovim plugin has been moved to a separate repository: [github.com/computerscienceiscool/vimbeam](https://github.com/computerscienceiscool/vimbeam)

Vimbeam's Lua plugin talks JSON to its Node helper:
- Neovim → Helper:
...
- Helper → Neovim:
  - `{"type":"connected","userId":"beam-..."}` / `{"type":"opened","docId":...,"content":...}` / `{"type":"changed","content":...}`
...
For implementation details, see the [Vimbeam PROTOCOL.md](https://github.com/computerscienceiscool/vimbeam/blob/main/docs/PROTOCOL.md).
...
- Vimbeam plugin: [github.com/computerscienceiscool/vimbeam](https://github.com/computerscienceiscool/vimbeam)
